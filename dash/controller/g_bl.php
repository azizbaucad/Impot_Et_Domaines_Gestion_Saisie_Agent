...
<td width="80"> <button  class="btn btn-success" onclick="addB();">Valider</button></td>
 ...
 <!-**************************************************Ajou Location*************************************->
	  ...
	  $bl=Achat::ADDLocation($_POST['fo'],$_POST['dt']);
	  
	echo '<script>location.href="../view/index.php?page=d_bl&&id='.$bl.'";</script>';

...
<td width="80"> <button  class="btn btn-success" onclick="addT();">Valider</button></td>
 ...
 <!-**************************************************Ajou Achat*************************************->
	  ...
	  $pp=Achat::ADDTrans($_POST['fo'],$_POST['dt']);
	  
	echo '<script>location.href="../view/index.php?page=d_tr&&id='.$pp.'";</script>';

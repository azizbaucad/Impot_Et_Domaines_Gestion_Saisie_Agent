...
if(isset($_POST['rr'])){
	...
	<div class="table-responsive">
        ...
        <li><a href="index.php?page=d_se&&id=<?php  echo $data->id_br; ?>" class="glyphicon glyphicon-folder-open " data-toggle="tooltip" data-placement="top" title="détail ce BR" ></a></li>
	...
	echo $html;
     ...
     include('../Model/achat.class.php');
		 ...
		 Achat::DeByIdA($_POST['supp']);
			...
			echo "<script>location.href='../view/index.php?page=se';</script>";
...
<td width="80"> <button  class="btn btn-success" onclick="addS();">Valider</button></td>
 ...
 <!-**************************************************Ajou Achat*************************************->
	  ...
	  $pp=Achat::ADDSeneau($_POST['fo'],$_POST['dt']);
	  
	echo '<script>location.href="../view/index.php?page=d_se&&id='.$pp.'";</script>';

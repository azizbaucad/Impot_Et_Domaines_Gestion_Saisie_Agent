...
function aff(){
	...
	$.post("../controller/g_tr.php",{rr:""+rr+""},function(data){
...
function affdM(){
	...
	$.post("../controller/g_de_tr.php",{ent:""+rr+"",idd:""+g+""},function(data){
...
function AffMA(){
	...
	$.post("../controller/g_de_tr.php",{tbl:""+rr+"",id:""+g+""},function(data){
...
function deletA(rr){
	...
	$.post("../controller/g_tr.php",{supp:""+rr+""},function(data){
...
function delet(rr){
	...
	$.post("../controller/g_de_tr.php",{iddA:""+rr+"",idA:""+g+""},function(data){
...
function PosteAj(){
	...
	$.post("../controller/g_de_tr.php",{pbl:""+rr+""},function(data){
...
function AjouDetBL(){
	...
	$.post("../controller/g_de_tr.php",{gid:""+g+"",
...
function affdiv(){
	...
	$.post("../controller/g_tr.php",{di:""+rr+""},function(data){
...
// replace addA to addB and call AddB in another fucntion
function addT(){
	...
	$.post("../controller/g_tr.php",{fo:""+forni+"",dt:""+dt+""},function(data){

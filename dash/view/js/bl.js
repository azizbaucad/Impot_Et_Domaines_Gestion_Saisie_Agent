...
function aff(){
	...
	$.post("../controller/g_bl.php",{rr:""+rr+""},function(data){
...
function affdM(){
	...
	$.post("../controller/g_de_bl.php",{ent:""+rr+"",idd:""+g+""},function(data){
...
function AffMA(){
	...
	$.post("../controller/g_de_bl.php",{tbl:""+rr+"",id:""+g+""},function(data){
...
function deletA(rr){
	...
	$.post("../controller/g_bl.php",{supp:""+rr+""},function(data){
...
function delet(rr){
	...
	$.post("../controller/g_de_bl.php",{iddA:""+rr+"",idA:""+g+""},function(data){
...
function PosteAj(){
	...
	$.post("../controller/g_de_bl.php",{pbl:""+rr+""},function(data){
...
function AjouDetBL(){
	...
	$.post("../controller/g_de_bl.php",{gid:""+g+"",
...
function affdiv(){
	...
	$.post("../controller/g_bl.php",{di:""+rr+""},function(data){
...
function addB(){
	...
	$.post("../controller/g_bl.php",{fo:""+forni+"",dt:""+dt+""},function(data){

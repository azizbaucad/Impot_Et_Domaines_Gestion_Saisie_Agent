    ...
    <!-- Login script -->
    <?php error_reporting(0); include('./controllers/confirm.php'); ?>
...
<div   style="background-color:#664c28;color:white;" class="card card-header card-outline card-primary"><h5 class="title">Formulaire de récupération du mot de passe</h5></div>
<div class="card-body">
        ...
        <div class="row justify-content-center align-items-center">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content clearfix">
                            ...
                            <style>img {width: 40%;} @media (min-width: 40em) {main {width: 80%;}}
                                ...
                                <center><img src="forgot.webp"> </center>
                ...
                <form action="" method="post">
                    ...
                    <span class=""><i class="fa fa-user"></i></span>
                        <input style="font-size:22px;" onkeyup="lemail()" type="email" class="form-control" name="email" id="email" placeholder="E-mail" />
                    ...
                    <span>
                        ...
                        <input style="font-size:22px;" onkeyup="lpass()" type="password" class="form-control" name="password" id="password" placeholder="Nouveau mot de passe" />
                    ...
                    <span>
                        ...
                        <input style="font-size:22px;" onkeyup="cpass()" type="password" class="form-control" name="c_password" id="c_password" placeholder="Confirmer nouveau mot de passe" />
                      ...
                      <div class="form-group">
                                <button type="submit" name="submit" id="submit" class="btn">Confirmer</button><br>
                                </div>

...
<div class="wrapper">
<nav  class="main-header navbar navbar-expand navbar-marron navbar-dark">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
...
DGID | Direction Générale des Impôts et des Domaines | Plateforme de saisie des données de sources internes</h5> </b></large></a>
  ...
  <aside class="main-sidebar sidebar-dark-default elevation-6">
  <div class="dropdown">
    ...
    <div class="sidebar">
      <nav class="mt-2">
        ...
        <!--?php if($_SESSION['login_type'] == 1): ?-->
          <li class="nav-item ">
            <a href="#" class="nav-link nav-edit_user bg-warning">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
              <?php if($_GET['page']=="achat" || $_GET['page']=="d_achat")?>
                <a href="?page=d_achat" class="nav-link nav-new_user tree-item bg-light">
              ...
              <li class="nav-item">
              <?php if($_GET['page']=="achat" || $_GET['page']=="d_achat")?>
                <a href="?page=achat" class="nav-link nav-user_list tree-item bg-light">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Liste</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link nav-is-tree nav-edit_document nav-view_document bg-info">

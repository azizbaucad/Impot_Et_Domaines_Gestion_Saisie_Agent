...
function affdM(){
	...
	$.post("../controller/g_de_se.php",{ent:""+rr+"",idd:""+g+""},function(data){
...
function AffMA(){
	...
	$.post("../controller/g_de_se.php",{tbl:""+rr+"",id:""+g+""},function(data){
...
function deletA(rr){
	...
	$.post("../controller/g_se.php",{supp:""+rr+""},function(data){
...
function delet(rr){
	...
	$.post("../controller/g_de_se.php",{iddA:""+rr+"",idA:""+g+""},function(data){
...
function PosteAj(){
	...
	$.post("../controller/g_de_se.php",{paj:""+rr+""},function(data){
...
function AjouDetBL(){
	...
	$.post("../controller/g_de_se.php",{gid:""+g+"",
...
function affdiv(){
	...
	$.post("../controller/g_se.php",{di:""+rr+""},function(data){
...
function addS(){
	...
	$.post("../controller/g_se.php",{fo:""+forni+"",dt:""+dt+""},function(data){
...
function lookup(val){
	...
	if(val.length==0){
		...
		$.post("../controller/g_de_se.php",{vl:val},function(data){
...
function pagination(pages){
	...
	$.post('../controller/g_se.php',{page:pages,rr:""+rr+""},function(data){

...
<div id="reponse"></div>
  ...
  <div class="form-group">
    ...
    <div class="col-xs-4">
      <input type="text" class="form-control" name="lg" id="lg"  required="" placeholder="Login" value="<?php echo $data->lastname; ?>">
    </div>
  </div> 
  ...
  <div class="form-group">
    ...
    <div class="col-xs-4">
      <input type="text" class="form-control" name="nom" id="nom"  required="" placeholder="Nom" value="<?php echo $data->firstname; ?>">
    </div>
  </div>
   ...
   <div class="form-group">
    ...
    <div class="col-xs-4">
      <input type="text" class="form-control "  name="pre" id="pre" placeholder="Prenom" value="<?php echo $data->is_active ?>">
    </div>
  </div>
  ...
  <!--div class="form-group">
    ...
    <div class="col-xs-4">
      <input type="text" class="form-control "  name="pass" id="pass" required="" placeholder="Password" value="<!?php echo $data->is_active; ?>">
    </div>
  </div-->
